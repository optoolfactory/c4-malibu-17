...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DeviceShutdownPreset", {PERSISTENT, INT, "9", "33", 1}},
    ...
    {"DrivingModel", {PERSISTENT, STRING, "op-model_default", "op-model_default", 1}},
    {"DrivingModelName", {PERSISTENT, STRING, "OP Model 7 (Default)", "OP Model 7 (Default)", 1}},
    ...
    {"PendingIssueReport", {CLEAR_ON_MANAGER_START, JSON, "{}", "{}"}},
