  ...
  def get_mapbox_speed_limit(self, now, time_validated, v_ego, sm):
    ...
    def make_request():
      try:
        ...
        if not frogpilot_utilities.is_url_pingable(self.mapbox_host):
        ...
        future_latitude, future_longitude = frogpilot_utilities.calculate_bearing_offset(current_latitude, current_longitude, current_bearing, v_ego)
